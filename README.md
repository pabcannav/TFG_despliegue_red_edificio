# Despliegue de red para el edificio de la Facultad de Física de la Universidad de Sevilla
Trabajo Fin de Grado para la obtención del titulo de Grado en Ingeniería Informatica - Ingeniería de Computadores realizado por Pablo Cano Navajas en el curso 2024/25 obteniendo una calificación de 10 en el mismo.
## Resumen
Este estudio examina el despliegue de una red de comunicaciones para un edificio de uso educativo, concretamente una facultad. Se realiza un recorrido que
abarca desde el analisis de requisitos, pasando por el diseño lógico y físico de la
